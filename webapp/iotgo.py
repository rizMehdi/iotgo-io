#this file was updated on Sun Aug 22 21:04:16 2021
...
with input_col:    
    ...
    st.write("if...")
    # ("Input1:")
    st.image("https://raw.githubusercontent.com/rizMehdi/IoTgo/main/images/cards/EN-inputCloud-ForecastPercipitationHigh.png", width=cardWidth)
    # ("Input2:")
...
with output_col:    
    ...
    st.write("then...")
    # ("Output1:")
    st.image("https://raw.githubusercontent.com/rizMehdi/IoTgo/main/images/cards/EN-ouputPhy-RotateMin.png", width=cardWidth)
    # ("Output2:")
