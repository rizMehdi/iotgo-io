...
basic.forever(function () {
    if (input.lightLevel() < 127){
        radio.sendValue("lightlevelLow",1)
    } else {
        basic.pause(1000)
    }
})''',language="javascript")
