...
#input_options=["noiseHigh",'noiseLow','touchNo','touchYes','accelHigh','accelLow','buttonNotPress','buttonPress','compassE','compassN','compassS','compassW','gestureShake','gestureTilt','lightlevelHigh','lightlevelLow','tempHigh','tempLow']
#output_options=['musicHappy','musicNone','musicSad','musicAlarm','displayInput','displayNone','displayText','iconHappy','iconNone','iconSad','showStripBlack','showStripRainbow','showStripGreen','showStripRed',]
...
##
##	 
##input_options= ("l\'accelerazione è alta" ,
...
##
##
##output_options= ('suona una melodia allegra' ,
##'smette di suonare' ,
